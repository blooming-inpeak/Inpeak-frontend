      ...
      <ModalContainer>
        ...
        <FeedbackBox>
          ...
          <p className="feedback-content">
            예를 들어, 이전 프로젝트에서는 A라는 문제를 정의하고 사용자 테스트를 통해 B 솔루션을 도출했습니다.
            결과적으로 사용자 만족도가 C% 향상되었습니다. 귀하의 답변은 사용자 중심 디자인에 대한 핵심 원칙과 접근
            방식을 잘 설명하고 있습니다. 그러나 면접 답변으로는 약간 더 구체적이고 차별화된 요소를 포함하면 더 강렬한
            인상을 남길 수 있습니다. 아래는 피드백과 개선 제안입니다.
          </p>
        </FeedbackBox>
        ...
        <MemoWrapper>
          <MemoToggle onClick={() => setIsMemoOpen(!isMemoOpen)}>
            ...
            <img
              className={`memo-toggle ${isMemoOpen ? 'open' : ''}`} 
